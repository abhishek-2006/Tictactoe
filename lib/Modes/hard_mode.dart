...
// Mode Color for Dialog (Hard Mode Red)
const Color _kHardModeColor = Color(0xFFF44336);
...
class HardModeState extends State<HardMode> with SingleTickerProviderStateMixin {
  ...
  void _runCpuTurn() {
    ...
    if (emptyCells.isNotEmpty) {
      // Hard Mode Logic: 70% chance of optimal move (Minimax level 5 search), 30% random
      List<int> move;

      if (_random.nextDouble() < 0.7) {
        // Placeholder/Simplified Minimax: 70% chance of a good move
        move = _getBestMove('O', depth: 5);
      } else {
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: const Text(
            ...
            style: TextStyle(
              color: _kHardModeColor, // Mode color
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('HARD MODE (VS CPU)', style: TextStyle(color: _currentAppBarTextColor)),
            ...
            Padding(
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _kHardModeColor,
